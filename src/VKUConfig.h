...
#define VKU_APP_PERMISSIONS L"notify,friends,photos,audio,video,docs,notes,pages,status,wall,groups,messages,notifications,stats,ads,offline,nohttps,questions,offers"
